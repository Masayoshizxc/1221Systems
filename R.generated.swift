...
struct _R {
  ...
  struct color {
    ...
    /// Color `InfoView`.
    var infoView: RswiftResources.ColorResource { .init(name: "InfoView", path: [], bundle: bundle) }

    /// Color `Label`.
    var label: RswiftResources.ColorResource { .init(name: "Label", path: [], bundle: bundle) }

    /// Color `Space`.
    var space: RswiftResources.ColorResource { .init(name: "Space", path: [], bundle: bundle) }

    /// Color `Status`.
    var status: RswiftResources.ColorResource { .init(name: "Status", path: [], bundle: bundle) }
  }
  ...
  struct image {
    ...
    /// Image `Planet`.
    var planet: RswiftResources.ImageResource { .init(name: "Planet", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
